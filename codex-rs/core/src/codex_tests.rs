    ...
    let section = Session::render_open_brain_project_bootstrap_section(
        ...
        &[
            OpenBrainProjectMemory {
                ...
                source_summary_node_id: None,
                quality_signal: Some("upgrade_required".to_string()),
            ...
            OpenBrainProjectMemory {
                ...
                scope_key: Some("/tmp/project".to_string()),
                updated_at: None,
                selection_reason: Some("project bootstrap".to_string()),
                confidence: Some(0.66),
                promotion_source: Some("existing".to_string()),
                source_summary_node_id: Some("summary-2".to_string()),
                quality_signal: None,
                source_thought_id: None,
...
fn render_open_brain_project_bootstrap_section_does_not_filter_generic_memory_types() {
    let section = Session::render_open_brain_project_bootstrap_section(
        ...
        &[OpenBrainProjectMemory {
            ...
            promotion_source: None,
            source_summary_node_id: None,
            quality_signal: Some("legacy".to_string()),
            source_thought_id: None,
            source_node_ids: vec!["summary-1".to_string()],
            source_event_ids: vec!["event-1".to_string()],
            superseded_at: None,
